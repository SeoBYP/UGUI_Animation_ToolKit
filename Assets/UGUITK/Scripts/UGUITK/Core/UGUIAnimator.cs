...
namespace UGUIAnimationToolkit.Core
{
    ...
    public abstract class UGUIAnimator
    {
        ...
        [NonSerialized] protected Dictionary<string, UIAnimationEvent> _eventMap;
        [NonSerialized] protected bool _isInitialized = false;
        [NonSerialized] protected UIAnimationContext _ctx;
        [NonSerialized] protected Component _owner;
        /// <summary>
