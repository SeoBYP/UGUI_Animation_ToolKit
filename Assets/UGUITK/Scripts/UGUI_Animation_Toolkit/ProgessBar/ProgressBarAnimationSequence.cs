...
{
    [Serializable]
    public class ProgressBarAnimationSequence
    {
        [SerializeReference] public List<ProgressBarAnimationModule> modules = new();
        
        public async UniTask PlayAsync(ProgressBarAnimationContext ctx)
        {
